...
```sh
  cd my-folder
  git clone https://github.com/Mike47ip/leaderboard.git
```
...
Feel free to check the [issues page](https://github.com/Mike47ip/leaderboard/issues).
...
This project is [MIT](https://github.com/Mike47ip/leaderboard/blob/development/LICENSE) licensed.
