...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_addNewScore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/addNewScore.js */ \"./src/modules/addNewScore.js\");\n/* harmony import */ var _modules_recentScores_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/recentScores.js */ \"./src/modules/recentScores.js\");\n/* harmony import */ var _modules_hitApi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/hitApi.js */ \"./src/modules/hitApi.js\");\n/* harmony import */ var _modules_showScores_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/showScores.js */ \"./src/modules/showScores.js\");\n/* harmony import */ var _modules_displayScore_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/displayScore.js */ \"./src/modules/displayScore.js\");\n\n\n\n\n\n\n\n(0,_modules_addNewScore_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n(0,_modules_recentScores_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n\nconst form = document.querySelector('form');\nconst userName = document.querySelector('#name');\nconst userScore = document.querySelector('#number');\nconst Scores = document.querySelector('#Scorelist');\nconst refreshButton = document.querySelector('#refresh');\n\nconst scoreContainer = () => {\n  Scores.innerHTML = '';\n};\n\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  if (userName.value && userScore.value) {\n    (0,_modules_hitApi_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(userName.value.trim(), userScore.value.trim());\n    scoreContainer();\n    form.reset();\n    (0,_modules_displayScore_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])().then((obj) => (0,_modules_showScores_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(obj, Scores));\n  }\n});\n\nrefreshButton.addEventListener('click', () => {\n  scoreContainer();\n  (0,_modules_displayScore_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])().then((obj) => (0,_modules_showScores_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(obj, Scores));\n});\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst addScore = async (user, score) => {\n  const response = await fetch(\n    'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/MMQ7MBZcKSEvlBIOtnAq/scores/',\n    {\n      method: 'POST',\n      headers: {\n        'Content-type': 'application/json; charset=UTF-8',\n      },\n      body: JSON.stringify({\n        user,\n        score,\n      }),\n    },\n  );\n\n  if (!response.ok) {\n    throw new Error(`HTTP error! status: ${response.status}`);\n  }\n\n  const result = await response.json();\n  return result;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addScore);\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/hitApi.js?");
